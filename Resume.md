...
- 熟练掌握Unity内置性能分析工具、Lua Profiler、Xcode、RenderDoc、UWA Gears等常用性能分析工具，对卡顿、内存、发热等性能优化工作有丰富的实际项目经验；
...
### 独立开发，2025.12～至今
已上线：
- CP 相机，一款为任意照片生成构图辅助线，辅助用户拍照的相机 APP，最高入榜中国大陆区 iOS 摄影录像免费榜 121 位。

### 网易，P3-3 高级游戏客户端开发工程师 ，2025.08~2025.12
...
- 负责项目的性能优化工作：
    内存（Lua配置表内存、内存泄露、Shader变体等）；
    卡顿（GC、Shader预热、自动化预加载等）；
- 开发战斗、关卡以及相机等核心模块；
